...
public class image extends SQLiteOpenHelper {
    public static final String databaseName1 = "UserInformation";
    ...
    public boolean addImageCat(String name,int img)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
